...
export default {
  // app: mensajes generales de la aplicación
  app: {
  ...
  // countdown: unidades de tiempo para cuentas atrás
  countdown: {
    months: 'mes | meses',
    days: 'día | días',
    hours: 'hora | horas',
  ...
  // error: mensajes de error genéricos
  error: {
  ...
  // game: funciones de competiciones patrocinadas
  game: {
    menu: {
  ...
  // message: mensajes de feedback al usuario
  //   toast: mensajes cortos tras acciones del usuario
  //   inline: avisos contextuales mostrados en la página
  message: {
    toast: {
      ...
      userProfileUpdateError: 'Ha ocurrido un error al actualizar tu perfil.',
      emailTaken: 'Esta dirección de email ya está en uso.',
      passwordsDontMatch: 'Las contraseñas no coinciden.',
      signupError: 'Ha ocurrido un error durante el registro. Inténtalo de nuevo.',
      usernameTaken: 'Este nombre de usuario ya está en uso.',
    },
    inline: {
      noTropeltxoMessages: 'No tienes mensajes en este tropeltxo',
      placeStandingsLogIn: 'Inicia sesión para ver las clasificaciones locales.',
      placeStandingsNoPlace: 'Actualiza tu información de ciudad para ver las clasificaciones locales.',
      porraClosed: 'No puedes hacer un equipo para esta competición.',
      porraCreateLogIn: 'Necesitas iniciar sesión para hacer un equipo.',
      porraViewLogIn: 'Inicia sesión para ver este equipo.',
      xedapAds: '¿Quieres ver tus anuncios aquí? ¡Contáctanos!',
    },
  },
  ...
  // place: funciones basadas en ubicación
  place: {
    menu: {
  ...
  race: {
    ...
    canceled: 'Cancelada',
    stage: 'Etapa | Etapas',
    stageToday: 'Etapa de hoy | Etapas de hoy',
    team: 'Equipo | Equipos',
    dorsal: {
  ...
  // subscription: flujo de suscripción premium
  subscription: {
  ...
  tropeltxo: {
    ...
    privateDescription: 'Sólo los usuarios invitados pueden unirse a este tropeltxo.',
    createTropeltxo: {
  ...
  // ui: elementos de interfaz compartidos (botones, campos, selectores, navegación)
  ui: {
    form: {
      actions: {
        cancel: 'Cancelar',
  ...
  // user: perfil de usuario y cuenta
  user: {
    menu: {
  ...
  // xedap: editor de avatar del ciclista
  xedap: {
    banner: {
      updateRider:
        'Actualiza tu ciclista en tu configuración. ¡Cientos de combinaciones diferentes para crear tu avatar único, miles si eres Gregario de lujo!',
    },
    form: {
      height: {
        label: 'Altura',
